...
class AddIngredientPopupBox(semanticsProvider: SemanticsNodeInteractionsProvider) :
    ComposeScreen<AddIngredientPopupBox>(
        semanticsProvider = semanticsProvider, viewBuilderAction = { hasTestTag("AddIngredientPopupContainer") }) {
    ...
    val addIngredientContent: KNode = addIngredientDialog.child { hasTestTag("AddIngredientContentContainer") }
}

class AddIngredientSearchBar(semanticsProvider: SemanticsNodeInteractionsProvider) :
    ComposeScreen<AddIngredientSearchBar>(
        semanticsProvider = semanticsProvider, viewBuilderAction = { hasTestTag("AddIngredientContentContainer") }) {

    private val searchIngredientBar: KNode = child { hasTestTag("SearchIngredientBar") }
    val searchResultContainer: KNode = searchIngredientBar.child { hasTestTag("IngredientSearchScrollableList") }
...
class AddIngredientEditNutritionInfo(semanticsProvider: SemanticsNodeInteractionsProvider) :
    ...
    val servingSizeLabel: KNode = servingSizeContainer.child { hasTestTag("NutritionLabel Serving Size") }
    ...
    val servingSizeInput: KNode = servingSizeContainer.child { hasTestTag("NutritionSizeInput Serving Size") }
    ...
    val servingSizeUnit: KNode = servingSizeContainer.child { hasTestTag("NutritionUnit Serving Size") }
