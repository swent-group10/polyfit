...
fun NutritionFacts() {
  ...
  (0..nutritionLabelCount).forEach { index ->
    Row(
        ...
        modifier = Modifier
            .testTag("NutritionInfoContainer " + nutritionLabels[index])
            .fillMaxWidth()
          ...
          Text(
              ...
              modifier = Modifier
                  .testTag("NutritionLabel " + nutritionLabels[index])
                  .weight(1.5f)
          )
          ...
          TextField(
              ...
              modifier = Modifier
                  .testTag("NutritionSizeInput " + nutritionLabels[index])
                  .weight(0.5f),
              singleLine = true,
              colors =
          ...
          Text(
              ...
              color = SecondaryGrey,
              modifier = Modifier
                  .testTag("NutritionUnit " + nutritionLabels[index])
                  .weight(0.4f)
                  .padding(start = 8.dp))
        }
    ...
    GradientBox(
      ...
      Column(
        ...
        AddButton(
            ...
            modifier = Modifier
                .testTag("AddIngredientToListButton")
