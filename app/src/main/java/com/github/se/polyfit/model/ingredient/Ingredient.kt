...
class Ingredient(
    ...
    var servingSize: Double by Delegates.observable(servingSize) { _, _, _ -> parentMeal?.updateMeal() }
    ...
    var carbohydrates: Double by Delegates.observable(carbohydrates) { _, _, _ -> parentMeal?.updateMeal() }
    ...
    companion object {
        ...
        /**
         * Converts a Map to an Ingredient.
        ...
        fun deserializeIngredient(data: Map<String, Any>): Ingredient {
            ...
            val servingSize =
                requireNotNull(data["servingSize"]) { "Missing 'servingSize'" } as Double
