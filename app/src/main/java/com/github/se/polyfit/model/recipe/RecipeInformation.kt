    ...
    companion object {
        fun serialize(recipeInfo: RecipeInformation): Map<String, Any> {
            return mutableMapOf<String, Any>().apply {
                ...
                this["listIngredients"] =
                    recipeInfo.listIngredients.map { Ingredient.serialize(it) }
        ...
        fun deserialize(data: Map<String, Any>): RecipeInformation {
            return try {
                ...
                val listIngredients = (data["listIngredients"] as List<Map<String, Any>>).map {
                    Ingredient.deserialize(it)
                }
                ...
                Log.e(
                    "RecipeInformation",
                    "Failed to deserialize RecipeInformation object: ${e.message}",
                    e
                )
